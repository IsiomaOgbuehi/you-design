...
export default function ProfileNav(){
    ...
    return (
      <div
        className={`bg-white ${style.wrapper} ${style.profileNav} profileNav`}
      >
        <div className={`container-fliud ${style.menuMain}`}>
          <div className={`${style.viewPublicProfile} viewPublicProfile`}>
            View Public Profile
          </div>
          <div className={`container`}>
            <div
              className={`row justify-content-between align-items-center profileNavMenu`}
            >
