...
const HeroTexts = () => {
    return (
        <>
            <ReactTypingEffect
                text={["Creatives", "Illustrators", "UX Designers", "Graphic Designers"]}
                cursor='_'
                speed={200}
                typingDelay={1000}
                eraseSpeed={200}
...
export default function HomePage() {
    ...
    return (
        ...
        >
                        ...
                        howItWorks === "Freelancer" ?
                            <div className={`row mt-4 mt-md-5`}>
                                ...
                                <div className={`col-md-6 offset-md-6`}>
                                    <div className="row">
                                        <div
                                            className={`col-md-8 col-lg-10 offset-lg-2 offset-md-4 text-center text-md-start`}
                                        >
                                            <Link
                                                href={{
                                                    pathname: "/signup",
                                ...
                                <div className={`col-md-6 mb-4 mb-lg-5`}>
                                    <div className="row">
                                        ...
                                        <div
                                            className={`col-md-8 col-lg-10 text-center text-md-start`}
                                        >
                                            <h5 className="default-primary-font-color2 mb-3">Pay up</h5>
                                            <div className="default-font-color3">
                                                Lorem ipsum dolor sit amet, consectetuer adipiscing elit,
                                                sed diam nonummy nibh euismod tincidunt ut laoreet{" "}
                                            </div>
                                ...
                                <div className={`col-md-6 mb-4 mb-lg-5`}>
                                    <div className="row">
                                        ...
                                        <div
                                            className={`col-md-8 col-lg-10 text-center text-md-start`}
                                        >
                                            <h5 className="default-primary-font-color2 mb-3">Approve and close</h5>
                                            <div className="default-font-color3">
                                                Lorem ipsum dolor sit amet, consectetuer adipiscing elit,
                                                sed diam nonummy nibh euismod tincidunt ut laoreet{" "}
                                            </div>
                                    ...
                                    <div className="row">
                                        ...
                                        >
                                            ...
                                            >
                                                <a className="text-decoration-none">
                                                    <div className="default-primary-font-color2 mb-3 fw-bold">
                                                        <span className="me-2">Start Your Project Now</span>
                                                        <span>
              <ImArrowRight2/>
            </span>
                                                    </div>
            ...
            {/* OUR IMPACT */}
            <div className={`px-3 py-3 pb-5 px-md-5 ${style.ourImapct} text-center flex-column align-items-center`}>
                <div
                    className={`container text-center flex-column align-items-center`}
                >
                    <h3 className={`pb-3 fw-bold`}>Our Impact</h3>
                    <div className={`fs-small m-auto ${style.impactText}`}>
